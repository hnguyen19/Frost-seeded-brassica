...
fsb.wide$species3 <-  factor(fsb.wide$species.y, levels =c("None",
                                                            "Arugula<br>(*Eruca vesicaria*)" ,    
                                                            "Broadleaf mustard<br>(*Brassica juncea*)",
                                                            "Brown mustard<br>(*Brassica juncea*)",
                                                            "Collard<br>(*Brassica oleracea*)",
                                                            "Kale<br>(*Brassica oleracea*)",
                                                            "Mustard<br>(*Sinapis alba*)",
                                                            "Oriental mustard<br>(*Brassica juncea*)",
                                                            "Radish<br>(*Raphanus raphanistrum* subsp. *sativus*)",
...
# fsb.wide.summ$species3 <- factor(fsb.wide.summ$species.y, levels =c("None",
#                                                             "Arugula<br>(*Eruca vesicaria*)" ,    
#                                                             "Broadleaf mustard<br>(*Brassica juncea*)",
#                                                             "Brown mustard<br>(*Brassica juncea*)",
#                                                             "Collard<br>(*Brassica oleracea*)",
...
#  labs(color= 'Cover crop') + 
 ...
 # geom_text(aes(labels = species3)) +
  theme(text = element_text(size=15), legend.position="none") #, legend.text = element_markdown())
```
