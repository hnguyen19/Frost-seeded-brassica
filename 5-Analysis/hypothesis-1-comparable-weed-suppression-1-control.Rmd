...
Weed suppression from different *Brassicacaea* species was comparable among each other and with the control treatments (Table \@ref(tab:ancova-weeds)), even though crop biomass differed by species (Table \@ref(tab:ancova-crops)). Crop biomass was the strongest factor affecting weed biomass (Table \@ref(tab:ancova-crops) and Figure \@ref(fig:nls-plot)).  
...
#  ggplot(aes(x = mean_x, y = mean_y )) +
  ...
  geom_vline(xintercept = 135.59/2, color = "grey", linetype="dashed") + # plot vertical line
  geom_hline(yintercept = 171.32/2, color = "grey", linetype="dashed")  # plot horizontal line
```
